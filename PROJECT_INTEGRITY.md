# RecapFlowAI Phase 6F.2.7 — Project Integrity
...
- Root project: `RecapFlowAI_Phase6F2_7`
- Application ID: `com.recapflow.ai`
- Version: `1.0-phase6f2.7`
...
- Current gate: AndroidIDE compile/install + owner-device Phase 6F.2.7 matrix
